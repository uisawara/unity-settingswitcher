...
namespace uisawara
{
    public class Settings
    {
        ...
        public int GetEnvironmentIndex(string environmentName)
        {
            ...
            {
                if (env.name == environmentName) return index;
                index++;
            }
        ...
        public string[] ResolveInherit(string environmentName)
        {
            ...
            while (current != null)
            {
                ...
                if (env == null) throw new ArgumentNullException("Inherit setting not found: " + current);
        ...
        public static void Merge(Environment lhs, Environment rhs)
        {
            ...
            {
                string v;
                if (lhs.player_settings == null) lhs.player_settings = new Dictionary<string, object>();
            ...
            // Merge settings
            if (rhs.build_settings != null) Merge(lhs.build_settings, rhs.build_settings);
            if (rhs.player_settings != null) Merge(lhs.player_settings, rhs.player_settings);
            if (rhs.editor_build_settings != null) Merge(lhs.editor_build_settings, rhs.editor_build_settings);
            if (rhs.editor_user_build_settings != null)
                Merge(lhs.editor_user_build_settings, rhs.editor_user_build_settings);
            if (rhs.xr_settings != null) Merge(lhs.xr_settings, rhs.xr_settings);
            if (rhs.android != null) Merge(lhs.android, rhs.android);
        }
        ...
        public static void Merge(Dictionary<string, object> lhs, Dictionary<string, object> rhs)
        {
            ...
            {
                if (lhs.ContainsKey(kv.Key)) continue;
