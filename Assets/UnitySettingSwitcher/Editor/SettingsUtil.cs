...
namespace uisawara
{
    public static class SettingsUtil
    {
        public static Settings LoadBuildSettings()
        {
            ...
            foreach (var sf in settingFiles) LoadBuildSettings(sf, result);
            return result;
        }
        ...
        public static Settings.Environment Create(Settings buildSettings, string[] envList)
        {
            ...
            if (sb.Length >= 1) sb.Remove(sb.Length - 5, 5);
            ...
            foreach (var env in resolvedEnvList)
            {
                ...
                if (index == -1) throw new ArgumentNullException("setting not found: " + env);
        ...
        public static void ChangeBuildSettings(Settings.Environment settingenvironment)
        {
            ...
            if (settingenvironment.android != null) ApplySettings(typeof(Android), settingenvironment.android);
                ...
                else
                {
                    ...
                    else if (pt.IsEnum)
                    {
                        ...
                        else
                        {
                            ...
                            uint flag = 0;
                            foreach (var t in tokens) flag |= (uint) Enum.Parse(pt, t, true);
